...
<body>
  ...
  <main>
    <section>
      <h2>tables à la une</h2>
      <p>Voici les dernieres tables ajoutées à notre site :</p>
      <ul>
        <ul>
        <?php
        ...
        try {
          ...
          $stmt = $conn->query("SELECT * FROM meuble WHERE categorie= 'table' ORDER BY id DESC");
