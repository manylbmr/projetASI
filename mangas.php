...
<body>
  ...
  <main>
    <section>
      ...
      <p>Voici les derniers mangas ajoutés à notre site :</p>
<ul>
        <ul>
        <?php
        ...
        try {
            ...
            $stmt = $conn->query("SELECT * FROM livre2 WHERE categorie= 'Mangas' ORDER BY id DESC ");
