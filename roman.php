...
<body>
  ...
  <main>
    <section>
      ...
      <p>Voici les derniers romans ajoutés à notre site :</p>
      <ul>
        <ul>
        <?php
        ...
        try {
            ...
            $stmt = $conn->query("SELECT * FROM livre2 WHERE categorie= 'Romans' ORDER BY id DESC ");
            ...
            foreach ($livres as $livre) {
                ...
                echo '<p>' . $livre['titre'] . ' publié par ' . $livre['auteur'] . ' dans la catégorie : ' . $livre['categorie'] . $livre['description'] .  '<br>Prix: ' . $livre['prix'] . ' DA <br> Vendu par Amel, numéro : 0655102821</p>';
